export default function TrustBar() {
  return (
    <section className="bg-[#E8E4DA] py-16 border-b border-[#0A2E4D]/08 rounded-t-[18px]">
      <div className="max-w-[1180px] mx-auto px-6 md:px-12 lg:px-20">
        <p className="font-mono text-[0.6875rem] uppercase tracking-[0.16em] text-[#0A2E4D]/35 mb-10">
          Notre engagement
        </p>
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-1 flex flex-col gap-3 py-8 md:py-0 md:pr-14 border-b border-[#0A2E4D]/10 md:border-b-0 md:border-r">
            <span className="text-5xl md:text-6xl font-bold tracking-[-0.03em] text-[#0A2E4D] leading-none">
