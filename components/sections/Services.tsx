      ...
      <AnimatePresence mode="popLayout">
        {items.map((item, i) => (
          <motion.div
            ...
            className="flex items-center gap-3 py-2 px-3 rounded-[10px] bg-white/[0.05] border border-[rgba(247,243,235,0.12)]"
          >
      ...
      <div className="relative z-10 max-w-[1180px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <motion.div
            ...
            className="md:col-span-2"
          >
            <SpotlightCard className="h-full rounded-[14px] bg-[#0A2E4D] border border-[rgba(247,243,235,0.12)] p-8 md:p-10 flex flex-col gap-5 shadow-[0_20px_60px_-20px_rgba(10,46,77,0.5)] hover:border-[rgba(247,243,235,0.36)] transition-colors duration-300">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-2">
                {['Stabilisation', 'Documentation', 'Formation', 'Optimisation'].map((kw) => (
                  ...
                  >
                    ...
                    <span className="text-[11px] text-[rgba(247,243,235,0.6)] font-medium">
                      {kw}
                    </span>
                  </div>
                ))}
