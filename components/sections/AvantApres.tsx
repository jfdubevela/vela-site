...
export default function AvantApres() {
  return (
    <section id="avant-apres" className="bg-[#E8E4DA] py-28 md:py-36 overflow-hidden relative rounded-t-[18px]">
      ...
      <div className="absolute right-0 bottom-0 w-[380px] h-[260px] hidden lg:block pointer-events-none select-none">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-l from-transparent to-[#E8E4DA]" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#E8E4DA] to-transparent" />
      </div>
      ...
      <div className="relative z-10 max-w-[1180px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 rounded-[14px] overflow-hidden shadow-[0_20px_60px_-20px_rgba(10,46,77,0.12)]">
          {/* AVANT */}
          <div className="bg-[#EDE9E0] p-8 md:p-10 flex flex-col gap-6">
            <div>
              <p className="font-mono text-[0.6875rem] uppercase tracking-[0.16em] text-[#0A2E4D]/40 mb-1">Avant VELA</p>
              ...
              {before.map((item, i) => (
                <ScrollReveal key={i} delay={i * 0.07}>
                  <div className="flex items-start gap-3">
                    <XCircle size={18} weight="regular" className="text-rose-400/70 mt-0.5 shrink-0" />
          ...
          <div className="bg-[#0A2E4D] p-8 md:p-10 flex flex-col gap-6">
            <div>
              <p className="font-mono text-[0.6875rem] uppercase tracking-[0.16em] text-[#7DB7D6]/70 mb-1">Avec VELA</p>
