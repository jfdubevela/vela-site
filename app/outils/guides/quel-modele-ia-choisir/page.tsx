      ...
      <main className="bg-[#122434]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 items-center">
              ...
              <div className="flex flex-col gap-8 max-w-[640px]">
                ...
                <motion.h1
                  ...
                  className="text-[clamp(2.2rem,5vw,4rem)] font-medium tracking-[-0.02em] leading-[0.95] text-[#F7F3EB]"
                >
                  Quel modèle d&apos;I.A.
                  <br />
                ...
                <motion.p
                  ...
                  className="text-base md:text-lg text-[rgba(247,243,235,0.58)] leading-relaxed max-w-[48ch]"
                >
                ...
                >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 text-sm font-medium text-[rgba(247,243,235,0.65)] hover:text-[#E8E4DA] transition-colors"
                  >
                    Voir l&apos;aperçu
              ...
              >
                <div className="rounded-[14px] border-4 border-[rgba(247,243,235,0.12)] shadow-[0_24px_60px_-12px_rgba(0,0,0,0.5)] overflow-hidden rotate-2">
                  <Image
                    src={previews[0].src}
          ...
          <div className="max-w-[1100px] mx-auto px-6 md:px-12 lg:px-20">
            ...
            <ScrollReveal>
              <div className="mb-12 text-center md:text-left">
                ...
                <h2 className="text-[clamp(1.7rem,3.5vw,2.6rem)] font-medium tracking-[-0.02em] leading-[1.05] text-[#0A2E4D] max-w-[26ch]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
              {niveaux.map((n, i) => (
                <ScrollReveal key={n.title} delay={0.15 + i * 0.08}>
                  <div
                    className="h-full rounded-[14px] bg-white border p-7 flex flex-col gap-5 shadow-[0_8px_40px_-12px_rgba(10,46,77,0.1)]"
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1">
                      <h3 className="text-xl font-bold tracking-[-0.02em] text-[#0A2E4D]">{n.title}</h3>
                      <p className="text-sm font-semibold text-[#0A2E4D]/60">{n.subtitle}</p>
                    </div>
                    <ul className="flex flex-col gap-2.5">
                      {n.items.map((item) => (
                        <li key={item} className="flex items-start gap-3">
                          <CheckCircle size={16} weight="regular" style={{ color: n.accent }} className="mt-0.5 shrink-0" />
        ...
        <section className="relative py-24 md:py-32 bg-[#E8E4DA]">
          <div className="max-w-[1100px] mx-auto px-6 md:px-12 lg:px-20">
            ...
            <ScrollReveal delay={0.1}>
              <div className="rounded-[18px] overflow-hidden border border-[#0A2E4D]/[0.08] shadow-[0_8px_40px_-12px_rgba(10,46,77,0.1)]">
                {/* Header */}
                <div className="hidden md:grid grid-cols-[160px_1fr_1fr] bg-[#0A2E4D] text-[rgba(247,243,235,0.6)] font-mono text-[0.6875rem] uppercase tracking-[0.16em] font-mono">
                ...
                {comparatif.map((row, i) => (
                  ...
                  >
                    <div className="px-6 py-6 flex flex-col gap-1.5">
                      <span
                        className="inline-flex self-start text-[10px] font-mono uppercase tracking-[0.16em] px-2.5 py-0.5 rounded-full"
          ...
          <div className="relative z-10 max-w-[1180px] mx-auto px-6 md:px-12 lg:px-20">
            ...
            <ScrollReveal>
              <div className="text-center mb-14">
                ...
                <h2 className="text-[clamp(2rem,4vw,3rem)] font-medium tracking-[-0.02em] leading-[0.95] text-[#F7F3EB] max-w-[26ch] mx-auto">
                  Les 2 pages, telles
                  <br />
              ...
              {previews.map((p, i) => (
                <ScrollReveal key={p.src} delay={i * 0.1}>
                  ...
                  >
                    ...
                    <p className="text-center text-xs text-[rgba(247,243,235,0.3)] font-mono mt-3 tracking-wide">
                      {p.label}
                    </p>
                  </a>
                </ScrollReveal>
        ...
        <section className="relative py-24 md:py-32 bg-[#E8E4DA]">
          <div className="max-w-[1100px] mx-auto px-6 md:px-12 lg:px-20">
            <ScrollReveal>
              <div className="rounded-[14px] bg-[#0A2E4D] p-10 md:p-14 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
