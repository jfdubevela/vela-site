  ...
  return (
    <div className="rounded-[14px] border border-[#C9A961]/30 bg-white p-8 md:p-12 shadow-[0_8px_40px_-12px_rgba(10,46,77,0.1)]">
      <div className="flex flex-col gap-8">
        ...
        {/* Title */}
        <h2 className="text-[clamp(1.6rem,3.5vw,2.6rem)] font-medium tracking-[-0.02em] leading-tight text-[#0A2E4D]">
          {f.title}
        </h2>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pt-4 border-t border-[#0A2E4D]/[0.08]">
          <div className="flex flex-wrap gap-6">
            <div className="flex flex-col gap-1">
              <span className="font-mono text-[0.6875rem] uppercase tracking-[0.16em] text-[#0A2E4D]/40 font-mono">Format</span>
              <span className="text-[0.9375rem] text-[#0A2E4D]/70">{f.format}</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="font-mono text-[0.6875rem] uppercase tracking-[0.16em] text-[#0A2E4D]/40 font-mono">Durée</span>
              <span className="text-[0.9375rem] text-[#0A2E4D]/70">{f.duration}</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="font-mono text-[0.6875rem] uppercase tracking-[0.16em] text-[#0A2E4D]/40 font-mono">Pour qui</span>
    ...
    <>
      ...
      <main className="bg-[#122434]">
        ...
        <section id="hero" className="relative min-h-[75dvh] flex items-center overflow-hidden pt-20">
          ...
          <div className="relative z-10 max-w-[1180px] mx-auto px-6 md:px-12 lg:px-20 py-24 w-full">
            <div className="flex flex-col gap-8 max-w-[720px]">
              ...
              >
                <span className="inline-flex items-center gap-2 px-6 py-2 rounded-full border border-[#7DB7D6]/50 bg-[#C5DCE8] text-[#1C3D55] text-[15px] font-medium tracking-wide">
                  <Chalkboard size={15} weight="regular" />
                  Formations
                </span>
              </motion.div>
          ...
          >
            <span className="font-mono text-[0.6875rem] uppercase tracking-[0.16em] text-[rgba(247,243,235,0.22)]">
              Nos formations
            </span>
            <motion.div
              animate={{ y: [0, 6, 0] }}
            ...
            >
              <ArrowDown size={14} className="text-[rgba(247,243,235,0.22)]" />
            </motion.div>
          </motion.div>
        </section>

        {/* ─── Formations ─── */}
        <section id="formations-list" className="relative py-24 md:py-32 bg-[#E8E4DA] rounded-t-[18px] shadow-[0_-12px_40px_rgba(0,0,0,0.2)]">
                      ...
                      >
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex flex-col gap-2">
                            ...
                            <Chalkboard size={20} weight="regular" className="text-[#0A2E4D]/60" />
                          </div>
                          <div
                          ...
                          >
                            {isOpen ? <Minus size={13} weight="regular" /> : <Plus size={13} weight="regular" />}
                          </div>
                        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-20 items-center">
              ...
              <div className="flex flex-col gap-8">
                ...
                <motion.h2
                  ...
                  className="text-[clamp(2.4rem,5vw,4rem)] font-medium tracking-[-0.02em] leading-[0.92] text-[#F7F3EB]"
                >
                  Prêt à former
                  <br />
              ...
              <ScrollReveal delay={0.15}>
                <div className="rounded-[14px] glass p-8 md:p-10 flex flex-col gap-6">
                  {sent ? (
                    ...
                    <>
                      <div className="flex flex-col gap-1">
                        <p className="text-base font-semibold text-[#E8E4DA]">Laissez vos coordonnées</p>
                      ...
                      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col gap-1.5">
                          <label className="text-xs text-[rgba(247,243,235,0.5)]">Formation souhaitée</label>
                          <select
                            name="formation"
                            required
                            defaultValue=""
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div className="flex flex-col gap-1.5">
                            ...
                            <input name="nom" type="text" required placeholder="Marie Tremblay" className="w-full px-4 py-3.5 rounded-[10px] bg-[rgba(247,243,235,0.04)] border border-[rgba(247,243,235,0.2)] text-[#F7F3EB] text-[0.9375rem] placeholder:text-[rgba(247,243,235,0.3)] focus:outline-none focus:border-[#7DB7D6] focus:bg-[rgba(125,183,214,0.08)] transition-colors duration-[140ms]" />
                          </div>
                          <div className="flex flex-col gap-1.5">
                            <label className="text-xs text-[rgba(247,243,235,0.5)]">Courriel professionnel</label>
                            <input name="courriel" type="email" required placeholder="marie@entreprise.com" className="w-full px-4 py-3.5 rounded-[10px] bg-[rgba(247,243,235,0.04)] border border-[rgba(247,243,235,0.2)] text-[#F7F3EB] text-[0.9375rem] placeholder:text-[rgba(247,243,235,0.3)] focus:outline-none focus:border-[#7DB7D6] focus:bg-[rgba(125,183,214,0.08)] transition-colors duration-[140ms]" />
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div className="flex flex-col gap-1.5">
                            ...
                            <input name="typeEntreprise" type="text" placeholder="Ex : clinique, agence..." className="w-full px-4 py-3.5 rounded-[10px] bg-[rgba(247,243,235,0.04)] border border-[rgba(247,243,235,0.2)] text-[#F7F3EB] text-[0.9375rem] placeholder:text-[rgba(247,243,235,0.3)] focus:outline-none focus:border-[#7DB7D6] focus:bg-[rgba(125,183,214,0.08)] transition-colors duration-[140ms]" />
                          </div>
                          <div className="flex flex-col gap-1.5">
                            <label className="text-xs text-[rgba(247,243,235,0.5)]">Taille de l&apos;entreprise</label>
                            <select name="tailleEntreprise" defaultValue="" className="w-full px-4 py-3.5 rounded-[10px] bg-[rgba(247,243,235,0.04)] border border-[rgba(247,243,235,0.2)] text-[#F7F3EB] text-[0.9375rem] focus:outline-none focus:border-[#7DB7D6] focus:bg-[rgba(125,183,214,0.08)] transition-colors duration-[140ms] appearance-none cursor-pointer">
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <textarea name="message" rows={3} placeholder="Décrivez brièvement votre contexte..." className="w-full px-4 py-3.5 rounded-[10px] bg-[rgba(247,243,235,0.04)] border border-[rgba(247,243,235,0.2)] text-[#F7F3EB] text-[0.9375rem] placeholder:text-[rgba(247,243,235,0.3)] focus:outline-none focus:border-[#7DB7D6] focus:bg-[rgba(125,183,214,0.08)] transition-colors duration-[140ms] resize-none" />
                        </div>
