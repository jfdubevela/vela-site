...
export const metadata: Metadata = {
  ...
  description:
    "Servez-vous vraiment de l'I.A. en sessions 1-on-1, sans jargon. Roadmap personnalisée pour pros et dirigeants. Session découverte gratuite, région de Montréal.",
